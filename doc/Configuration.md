# Configuration Dashboard <br/> Dashboards Microservice
...
[Pip.Services Configuration Dashboard](https://github.com/pip-services/pip-services/blob/master/usage/Configuration.md)
...
Example:
```yaml
- descriptor: "service-dashboards:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
...
Example:
```yaml
- descriptor: "service-dashboards:service:seneca:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 3000
